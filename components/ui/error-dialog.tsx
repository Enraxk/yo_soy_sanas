...
import { AlertDialog, AlertDialogContent, AlertDialogHeader, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogAction } from "./alert-dialog";
 ...
 */
export function ErrorDialog({ title, description, actionLabel = "Cerrar", onAction }: { title: string; description: string; actionLabel?: string; onAction?: () => void }) {
